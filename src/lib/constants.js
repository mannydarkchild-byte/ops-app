...
export const ALLOWED_COLUMNS = {
  ...
  events: ["id", "site_id", "shift_id", "machine_id", "operator_id", "operator_name", "type", "reason", "note", "stopped_at", "restarted_at", "downtime_minutes", "status", "photo_ref", "photo_data", "timestamp", "created_at", "updated_at"],
  expenses: ["id", "site_id", "machine_id", "operator_id", "operator_name", "category", "amount", "vendor", "description", "receipt_ref", "receipt_photo", "date", "created_at", "updated_at"],
  inspections: ["id", "site_id", "machine_id", "operator_id", "operator_name", "type", "category", "item_name", "status", "photo_ref", "photo", "remark", "inspection_id", "timestamp", "created_at", "updated_at"],
  ...
  issue_messages: ["id", "issue_id", "sender_id", "sender_name", "sender_role", "type", "text", "media_ref", "media_url", "media_type", "created_at"],
  work_sessions: ["id", "site_id", "machine_id", "operator_id", "operator_name", "assigned_supervisor_id", "assigned_supervisor_name", "clock_in", "clock_out", "status", "notes", "supervisor_signature_ref", "supervisor_signature", "signature_name", "signature_date", "created_at", "updated_at"],
  ...
  fuel_logs: ["id", "site_id", "machine_id", "shift_id", "operator_id", "operator_name", "litres", "hour_meter", "tank_level", "photo_pump_ref", "photo_dipstick_ref", "photo_pump", "photo_dipstick", "note", "timestamp", "created_at", "updated_at"],
  machine_hour_readings: ["id", "site_id", "machine_id", "operator_id", "operator_name", "reading", "photo_ref", "reading_at", "source", "shift_id", "notes", "created_at", "updated_at"],
