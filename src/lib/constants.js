...
export const ALLOWED_COLUMNS = {
  ...
  work_sessions: ["id", "site_id", "machine_id", "operator_id", "operator_name", "clock_in", "clock_out", "status", "notes", "supervisor_signature_ref", "supervisor_signature", "signature_name", "signature_date", "created_at", "updated_at"],
